...
1. **Project Management Tool**
   - A web application for managing projects and tasks, built using React and Node.js.
2. **E-commerce Website**
   - Developed an online store with features like cart management, user authentication, and payment integration using Django.
3. **Personal Portfolio**
   - Created a personal portfolio website to showcase my work and skills.

## Contact
- Email: gugan@example.com  
